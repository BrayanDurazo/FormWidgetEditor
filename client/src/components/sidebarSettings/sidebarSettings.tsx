...
const SidebarSettings = (props: SidebarSettingsProps) => {
  ...
  const setTitleAlignment = (
    updatedTitleAlignment: 'left' | 'center' | 'right'
  ) => {
    const updatedFormWidget: FormWidget = {
      ...formWidget,
      title: {
  ...
  const setSubTitleAlignment = (
    updatedSubTitleAlignment: 'left' | 'center' | 'right'
  ) => {
    const updatedFormWidget: FormWidget = {
      ...formWidget,
      subTitle: {
  ...
  return (
    <div className="sidebar-container">
      <div className="title-settings-container">
        ...
        />
        <FontSizeInput
          fontSize={formWidget.title.fontSize}
          setFontSize={setTitleFontSize}
        />
        <TextAlignmentInput
          textValue={'title'}
          alignment={formWidget.title.alignment}
          setAlignment={setTitleAlignment}
        ></TextAlignmentInput>
        <FontColorInput
          textValue={'title'}
          fontColor={formWidget.title.fontColor}
      ...
      <div className="title-settings-container">
        ...
        />
        <FontSizeInput
          fontSize={formWidget.subTitle.fontSize}
          setFontSize={setSubTitleFontSize}
        />
        <TextAlignmentInput
          textValue={'subtitle'}
          alignment={formWidget.subTitle.alignment}
          setAlignment={setSubTitleAlignment}
        ></TextAlignmentInput>
        <FontColorInput
          textValue={'subtitle'}
          fontColor={formWidget.subTitle.fontColor}
