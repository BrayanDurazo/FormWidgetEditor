...
const FormPreview = (props: FormPreviewProps) => {
  ...
  const { title, subTitle, firstNameRequired, lastNameRequired, submitButton } =
    props;
    ...
    <>
      <div className="simple-form-container">
        <div className="title-alignment-container">
          ...
          >
            {title.textContent || 'Here goes your title'}
          </h1>
          <h1
          ...
          >
            {subTitle.textContent || 'Here goes your subtitle'}
          </h1>
        </div>
        ...
        >
          {submitButton.textContent || 'Alterable Submit'}
        </button>
      </div>
    </>
  );
